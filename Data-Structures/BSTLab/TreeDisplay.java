...
public class TreeDisplay extends JComponent
{
     ...
     * @return the Dimension object created
     */
     ...
     * @param g2 the Graphics handle
     * @param t the treeNode
     * @param minX beginning x
     * @param maxX end x
     * @param y y value
    ...
    private void drawTree(Graphics2D g2, TreeNode t, int minX, int maxX, int y, int yIncr)
    {
        ...
        FontMetrics font = g2.getFontMetrics();
        String text = "";
        if ((t.getValue()) instanceof KeyValue)
        {
            text = ((KeyValue) t.getValue()).getKey() + "";         
        }
        else
        {
            text = t.getValue() + "";
     ...
     * @param rootIn is the root of the tree to display
     * postcondition: the component displays the tree defined by rootIn
     */
    public void displayTree(TreeNode rootIn)
    {
        this.root = rootIn;
    ...
    /**
     * sets the tester to the BinaryTester passed
     * @param tester the BinaryTester passed
     */
